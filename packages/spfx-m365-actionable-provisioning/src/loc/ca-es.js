/**
 * Catalan strings for provisioning-ui module.
 */
define([], function () {
  return {
    ConfirmDialog: {
    ...
    ProvisioningActivityEntry: {
      ...
      SkipReasonAlreadyExists: 'Ja existeix',
    ...
    ProvisioningDialog: {
      ...
      CloseLabel: 'Tanca',
      BackToProvisioningLabel: 'Enrere',

      TargetSiteLabel: 'Lloc de destinació',
      TargetSiteMissingTitle: 'Falta el lloc de destinació',
      TargetSiteMissingMessage: 'Seleccioneu un lloc de destinació a les propietats de la part web abans d\'executar el proveïment.',
      ...
      InitialHelpProvisioningText: 'Utilitzeu Executa per iniciar el proveïment al lloc de destinació. Podeu revisar el progrés i els registres mentre s\'executen les accions.',
      InitialHelpComplianceText: 'Utilitzeu Comprova per previsualitzar els problemes de compliment abans d\'aplicar els canvis.',
      ...
      ComplianceTargetSiteMissingMessage: 'Cal una URL del lloc de destinació per executar la comprovació de compliment.',
    ...
    SiteSelectorField: {
      ...
      SearchSiteLabel: 'Cerca lloc',

      SelectedSiteGroupAriaLabel: 'Lloc seleccionat',
      SearchSitesAriaLabel: 'Cerca llocs',
      SearchPlaceholder: 'Cerca per títol o URL',

      SearchingLabel: 'Cercant',
      EmptySearchLabel: 'Escriviu per cercar',
      NoResultsLabel: 'No s\'han trobat resultats',
    },

    NavigationGuard: {
      LeavePageWarning: 'Hi ha una operació en curs. Si sortiu, s\'interromprà.',
    },
  };
});
